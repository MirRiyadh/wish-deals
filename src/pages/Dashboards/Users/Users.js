...
const Users = () => {
    ...
    fetch(
      ...
      .then((data) => {
        if (data.acknowledged) {
          toast.success("Admin made successfully", 4000);
          refetch();
        }
      });
  };
  ...
  const handleVerify = (id) => {
    fetch(
      ...
      .then((data) => {
        if (data.acknowledged) {
          toast.success("Verify successfully", 4000);
          refetch();
        }
      });
  };
  ...
  return (
    <div className="md:w-11/12  m-auto">
      <h1 className="text-2xl lg:my-3 mb-3 font-semibold">User Lists</h1>
                  ...
                  {user?.role !== "admin" ? (
                    <>
                      <button
                        ...
                        className="bg-amber-500 hover:bg-sky-500 px-3 py-1 rounded-2xl font-semibold capitalize text-white"
                      >
                        Make Admin
                      </button>
                    </>
                    ...
                    <>
                      <button
                        onClick={() => handleAdmin(user._id)}
                        className="bg-sky-500 px-8 py-1 rounded-2xl font-semibold capitalize text-white"
                      >
                        Admin
                      </button>
                    </>
                  ...
                  {user?.verified === true ? (
                    <>
                      <button
                        ...
                        className="bg-teal-500 px-6 py-1 rounded-2xl font-semibold capitalize text-white"
                      >
                        verify
                      </button>
                    </>
                    ...
                    <>
                      <button
                        onClick={() => handleVerify(user._id)}
                        className="bg-gray-400 hover:bg-teal-500 px-3 py-1 rounded-2xl font-semibold capitalize text-white"
                      >
                        Not verify
                      </button>
                    </>
