...
const Sellers = () => {
  ...
  return (
    <div className="md:w-11/12  m-auto">
      <h1 className="text-2xl lg:my-3 mb-3 font-semibold">Seller Lists</h1>
            ...
            {sellers.map((user) => (
              <tr class="bg-white border-b dark:bg-orange-50 dark:border-gray-300 hover:bg-gray-50 dark:hover:bg-gray-200">
                ...
                <td class="py-4 px-6 ">
                  {user?.verified === true ? (
                    <>
                      <span className="bg-teal-500 px-6 py-1 rounded-2xl font-semibold capitalize text-white">
                        verify
                      </span>
                    </>
                  ) : (
                    <>
                      <span className="bg-gray-400  px-3 py-1 rounded-2xl font-semibold capitalize text-white">
                        Not verify
                      </span>
                    </>
                  )}
